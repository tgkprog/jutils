...
page import="org.s2n.ddt.util.SerUtils"%><%@ 
page import="org.s2n.ddt.util.Base64"%><%@ 
page import="java.net.*"%><%@ 
page import="java.io.*"%><%@ 
page import="java.util.*"%><%@ 
page import="javax.net.ssl.*"%><%!

private static Logger logger = Logger.getLogger("org.s2n.ddt.webJsps.serUtl.TestStepSend");
...
private static int timeout = 1000*30; //30 sec
	...
	private static String location = "/u/data/config/2_trust.jks";
	private static String password = "bb4mOd3w";	
